...
import { NativeSyntheticEvent, Text, TextInput, TextInputKeyPressEventData, TouchableOpacity, View } from "react-native";
  ...
  return (
    <View className="flex-1 bg-backgroundtwo px-12 pt-12 justify-between">
      ...
      <View className="items-center mb-20">
        <Text className="text-black font-notosans-regular text-base">Didn’t receive an OTP?</Text>
